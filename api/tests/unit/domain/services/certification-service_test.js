...
describe('Unit | Service | Certification Service', function() {
  ...
  describe('#getCertificationResult', () => {
    ...
    const certificationAssessement = new Assessment({ id: 'assessment_id', userId: 'user_id' });
    ...
    it('should call User Service to get ProfileToCertify', function() {
      ...
      return promise.then(() => {
        ...
        sinon.assert.calledWith(UserService.getProfileToCertify, certificationAssessement.get('userId'));
      });
    });
